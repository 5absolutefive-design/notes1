  ...
  const CommonGroups = () => (
    <>
      ...
      <div className="border border-zinc-400 rounded-lg p-1.5">
        <div className="flex flex-col gap-1">
          <button onClick={handleCopy} title="Copy" className={btnSq}><img src="/copy-icon.jpg" alt="Copy" style={{ width: 18, height: 18, objectFit: "contain" }} /></button>
        ...
        <div className="px-3 pt-2 pb-1.5 shrink-0" style={{ backgroundColor: tc.outer }}>
          ...
          <div className="mx-3 mb-2 border border-zinc-200/80 rounded-xl shadow-[inset_0_2px_3px_rgba(0,0,0,0.05)] px-3 py-1.5 flex items-center gap-1 overflow-x-auto" style={{ backgroundColor: tc.inner }}>
            ...
            <div className="flex items-center rounded-lg border border-zinc-300 overflow-hidden shrink-0">
              <button onClick={handleCopy} title="Copy" className="w-8 h-8 bg-white hover:bg-blue-50 active:bg-blue-100 transition-colors border-r border-zinc-300 flex items-center justify-center"><img src="/copy-icon.jpg" alt="Copy" style={{ width: 16, height: 16, objectFit: "contain" }} /></button>
