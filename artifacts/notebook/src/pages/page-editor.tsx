    ...
    <div className="h-screen bg-white flex flex-col overflow-hidden">
      ...
      {pageType === "spreadsheet" ? (
        ...
        <div className="bg-[#ece9e3] px-3 pt-2 pb-1.5 shrink-0">
          ...
          <div className="mx-3 mb-2 bg-[#ddd8d1] border border-zinc-400/40 rounded-xl shadow-[inset_0_2px_6px_rgba(0,0,0,0.15)] px-3 py-1.5 flex items-center gap-1 overflow-x-auto">
