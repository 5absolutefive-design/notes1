...
export default function PageEditor() {
  ...
  const CommonGroups = () => (
    <>
      ...
      <div className="border border-zinc-400 rounded-lg p-1.5">
        <div className="flex flex-col gap-1">
          <button onClick={handleUndo} title="Undo" className={`${btnSq} text-base`}><img src="/undo-icon.jpg" alt="Undo" className="w-7 h-7 object-contain" /></button>
          <button onClick={handleRedo} title="Redo" className={`${btnSq} text-base`}><img src="/redo-icon.jpg" alt="Redo" className="w-7 h-7 object-contain" /></button>
        </div>
      </div>
      ...
      <div className="border border-zinc-400 rounded-lg p-1.5">
        <div className="flex flex-col gap-1">
          <button onClick={() => setZoom(z => Math.min(200, z + 10))} title={`Zoom in (${zoom}%)`} className={btnSq}>
            <img src="/zoom-in-icon.jpg" alt="Zoom in" className="w-6 h-6 object-contain" />
          </button>
          <button onClick={() => setZoom(z => Math.max(50, z - 10))} title={`Zoom out (${zoom}%)`} className={btnSq}>
            <img src="/zoom-out-icon.jpg" alt="Zoom out" className="w-6 h-6 object-contain" />
          </button>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-1">
            <div className="relative" ref={fontMenuRef}>
              ...
              {showFontMenu && (
                <div className="absolute top-full left-0 mt-1 z-50 bg-white border border-zinc-300 rounded-lg shadow-lg overflow-y-auto max-h-72 w-80">
                  {FONTS.filter(f => f.toLowerCase().includes(fontSearch.toLowerCase())).map(f => (
                    <button key={f} onClick={() => handleFontChange(f)} className={`w-full text-left px-3 py-2 hover:bg-zinc-100 transition-colors flex items-center gap-3 ${font === f ? "bg-zinc-100" : ""}`}>
                      <span className="text-xs text-zinc-600 w-28 shrink-0 truncate">{f}</span>
                      <span className="text-base text-zinc-800 truncate" style={{ fontFamily: f }}>Akmdvijiszduh</span>
                    </button>
                  ))}
                </div>
              )}
      ...
      {pageType === "spreadsheet" ? (
        ...
        <div className="px-3 pt-2 pb-1.5 shrink-0" style={{ backgroundColor: tc.outer }}>
          ...
          <div className="mx-3 mb-2 border border-zinc-200/80 rounded-xl shadow-[inset_0_2px_3px_rgba(0,0,0,0.05)] px-3 py-1.5 flex items-center gap-1 overflow-x-auto" style={{ backgroundColor: tc.inner }}>
            ...
            {/* undo | redo — joined */}
            <div className="flex items-center rounded-lg border border-zinc-300 overflow-hidden shrink-0">
              <button onClick={handleUndo} title="Undo" className="w-8 h-8 bg-white hover:bg-blue-50 active:bg-blue-100 transition-colors border-r border-zinc-300 flex items-center justify-center"><img src="/undo-icon.jpg" alt="Undo" className="w-7 h-7 object-contain" /></button>
              <button onClick={handleRedo} title="Redo" className="w-8 h-8 bg-white hover:bg-blue-50 active:bg-blue-100 transition-colors flex items-center justify-center"><img src="/redo-icon.jpg" alt="Redo" className="w-7 h-7 object-contain" /></button>
            </div>
            ...
            <div className="flex items-center rounded-lg border border-zinc-300 overflow-hidden shrink-0">
              <button onClick={() => setZoom(z => Math.min(200, z + 10))} title="Zoom in" className="w-8 h-8 bg-white hover:bg-blue-50 active:bg-blue-100 transition-colors border-r border-zinc-300 flex items-center justify-center"><img src="/zoom-in-icon.jpg" alt="Zoom in" className="w-6 h-6 object-contain" /></button>
              <button onClick={() => setZoom(z => Math.max(50, z - 10))} title="Zoom out" className="w-8 h-8 bg-white hover:bg-blue-50 active:bg-blue-100 transition-colors flex items-center justify-center"><img src="/zoom-out-icon.jpg" alt="Zoom out" className="w-6 h-6 object-contain" /></button>
            </div>
            ...
            <div className="relative shrink-0" ref={fontMenuRef as React.RefObject<HTMLDivElement>}>
              ...
              <PortalPopup anchorRef={fontMenuRef} open={showFontMenu}>
                <div className="bg-white border border-zinc-300 rounded-lg shadow-lg overflow-y-auto max-h-72 w-80">
                  {FONTS.filter(f => f.toLowerCase().includes(fontSearch.toLowerCase())).map(f => (
                    <button key={f} onClick={() => handleFontChange(f)} className={`w-full text-left px-3 py-2 hover:bg-zinc-100 transition-colors flex items-center gap-3 ${font === f ? "bg-zinc-100" : ""}`}>
                      <span className="text-xs text-zinc-600 w-28 shrink-0 truncate">{f}</span>
                      <span className="text-base text-zinc-800 truncate" style={{ fontFamily: f }}>Akmdvijiszduh</span>
        ...
        <div className="px-3 pt-2 pb-1.5 shrink-0" style={{ backgroundColor: tc.outer }}>
          ...
          <div className="mx-3 mb-2 border border-zinc-200/80 rounded-xl shadow-[inset_0_2px_3px_rgba(0,0,0,0.05)] px-3 py-1.5 flex items-center gap-1 overflow-x-auto" style={{ backgroundColor: tc.inner }}>
            ...
            <div className="relative shrink-0" ref={fontMenuRef as React.RefObject<HTMLDivElement>}>
              ...
              <PortalPopup anchorRef={fontMenuRef} open={showFontMenu}>
                <div className="bg-white border border-zinc-300 rounded-lg shadow-lg overflow-y-auto max-h-72 w-80">
                  {FONTS.filter(f => f.toLowerCase().includes(fontSearch.toLowerCase())).map(f => (<button key={f} onClick={() => handleFontChange(f)} className={`w-full text-left px-3 py-2 hover:bg-zinc-100 transition-colors flex items-center gap-3 ${font === f ? "bg-zinc-100" : ""}`}><span className="text-xs text-zinc-600 w-28 shrink-0 truncate">{f}</span><span className="text-base text-zinc-800 truncate" style={{ fontFamily: f }}>Akmdvijiszduh</span></button>))}
                </div>
              </PortalPopup>
            </div>
            <div className="w-px h-6 bg-zinc-300 mx-0.5 shrink-0" />
            ...
            <div className="mx-3 mb-2 border border-zinc-200/80 rounded-xl shadow-[inset_0_2px_3px_rgba(0,0,0,0.05)] px-3 py-1.5 flex items-center gap-1 overflow-x-auto" style={{ backgroundColor: tc.inner }}>
              ...
              <div className="relative shrink-0" ref={fontMenuRef as React.RefObject<HTMLDivElement>}>
                ...
                <PortalPopup anchorRef={fontMenuRef} open={showFontMenu}>
                  <div className="bg-white border border-zinc-300 rounded-lg shadow-lg overflow-y-auto max-h-72 w-80">
                    {FONTS.filter(f => f.toLowerCase().includes(fontSearch.toLowerCase())).map(f => (
                      <button key={f} onClick={() => handleFontChange(f)} className={`w-full text-left px-3 py-2 hover:bg-zinc-100 transition-colors flex items-center gap-3 ${font === f ? "bg-zinc-100" : ""}`}><span className="text-xs text-zinc-600 w-28 shrink-0 truncate">{f}</span><span className="text-base text-zinc-800 truncate" style={{ fontFamily: f }}>Akmdvijiszduh</span></button>
                    ))}
                  </div>
                </PortalPopup>
              </div>
