                        ...
                        {dayTaskTypes.map(type => (
                          <div key={type.id} className="group/type relative">
                            <button
                              ...
                              className={`w-full text-center text-xs px-2 py-2 rounded-lg border transition-all truncate ${selectedTypeId === type.id ? "bg-stone-800 text-white border-stone-800" : "border-stone-300 text-stone-700 hover:border-stone-500 bg-white"}`}
                            >
                              {type.name}
                            </button>
                            <button
