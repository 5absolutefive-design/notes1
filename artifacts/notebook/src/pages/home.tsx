                        ...
                        {dayTaskTypes.map(type => (
                          <div key={type.id} className="group/type relative">
                            <button
                              ...
                              className={`w-full text-center text-xs px-2 py-2 rounded-lg border transition-all truncate shadow-sm hover:-translate-y-[2px] hover:shadow-md ${selectedTypeId === type.id ? "bg-stone-800 text-white border-transparent" : "border-stone-300 text-stone-700 bg-white"}`}
                            >
                              {type.name}
                            </button>
                            <button
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(14, 1fr)", gridTemplateRows: "1fr 1fr", gap: "4px" }}>
                      {days.slice(1).map((d, i) => (
                        <button
                          ...
                          className={`flex flex-col items-center justify-center rounded-lg border transition-all shadow-sm hover:-translate-y-[2px] hover:shadow-md ${selectedDate === d.key ? "bg-stone-800 text-white border-transparent" : "border-stone-300 text-stone-600 bg-white"}`}
                        >
