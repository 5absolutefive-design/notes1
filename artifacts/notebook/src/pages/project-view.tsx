...
export default function ProjectView({ projects, setProjects, activeId, setActiveId, onNewProject, focusTitleSignal }: ProjectViewProps) {
  ...
  useLayoutEffect(() => {
    ...
    let top = anchor.top;
    top = Math.min(top, vh - card.height - 8);
    top = Math.max(8, top);
  ...
  // After applying sub/superscript, move cursor OUTSIDE the <sup>/<sub> element
  // so subsequent typing is in normal mode.
    ...
    <div className="flex-1 flex flex-col min-h-0 bg-[#fafaf8]">
        ...
        >
                    ...
                    {FONTS_CTX.filter(f => f.toLowerCase().includes(ctxFontSearch.toLowerCase())).map((f, i, arr) => {
                      ...
                      return (
                        <button key={f}
                          ...
                          <span style={{ fontFamily: f, fontSize: 15, color: "#222", marginLeft: "auto", flexShrink: 0 }}>Abc</span>
                        </button>
                      );
                    })}
                  </div>
          ...
          <div className="flex">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 px-2 py-0.5 hover:bg-indigo-50 hover:text-indigo-700 text-stone-700 transition-colors text-xs font-medium">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 px-2 py-0.5 hover:bg-red-50 hover:text-red-600 text-stone-700 transition-colors text-xs font-medium">
      ...
      {calloutPickerPos && (
        <div
          ...
          className="fixed z-[20000] p-2.5 rounded-lg border border-stone-300 bg-white shadow-2xl grid grid-cols-2 gap-2"
