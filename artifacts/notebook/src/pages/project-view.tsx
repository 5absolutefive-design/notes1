          ...
          <div className="relative">
            ...
            <div className="absolute left-12 bottom-0 translate-y-1/2 z-10" ref={emojiPickerRef}>
              <button
                ...
                className="w-[100px] h-[80px] rounded-xl bg-white shadow-lg border border-stone-100 flex items-center justify-center text-4xl hover:scale-105 transition-transform"
                title="Change emoji"
              >
