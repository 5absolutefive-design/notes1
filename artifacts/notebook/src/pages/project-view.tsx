...
export default function ProjectView({ projects, setProjects, activeId, setActiveId, onNewProject, focusTitleSignal }: ProjectViewProps) {
  ...
  const insertDefinitionBlock = () => {
    insertHTML(
      ...
      `<p contenteditable="true" data-placeholder="Write something…" style="margin:0;color:#e5e3e1;font-size:13px;outline:none;font-family:Inter,sans-serif;min-height:40px"></p>` +
            ...
            {ctxMenu.blockOpen && (
              <div className="fixed bg-white rounded-xl shadow-2xl border border-stone-200 p-2 z-[10000]"
                ...
                <button onMouseDown={e => { e.preventDefault(); insertCardBlock(); }}
                  ...
                  <span className="w-7 h-7 rounded-md bg-white border border-stone-200 flex items-center justify-center text-base flex-shrink-0 shadow-sm">🃏</span>
                  <div>
                    <div className="text-xs font-semibold text-stone-700 group-hover:text-stone-900">Card</div>
                    <div className="text-[10px] text-stone-400">Floating white card</div>
                  </div>
                </button>
                {/* Numbered List */}
